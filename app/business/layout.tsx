import { LayoutDashboard, Package, Users, Settings, ShoppingCart, Wallet, RotateCcw } from "lucide-react";
  ...
  return (
    <DashboardShell
      ...
      nav={[
        ...
        { href: "/business/returns", label: "Returns", icon: <RotateCcw className="h-4 w-4" /> },
